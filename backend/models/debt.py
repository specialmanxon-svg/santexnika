...
class DebtRegistry(Base, UUIDMixin):
    ...
    debt_0_30: Mapped[float] = mapped_column(Numeric(12, 2), default=0, server_default="0")
    debt_30_60: Mapped[float] = mapped_column(Numeric(12, 2), default=0, server_default="0")
    debt_60_plus: Mapped[float] = mapped_column(Numeric(12, 2), default=0, server_default="0")
